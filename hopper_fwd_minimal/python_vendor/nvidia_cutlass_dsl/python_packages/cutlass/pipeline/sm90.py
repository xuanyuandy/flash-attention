    ...
    def create(
        *,
        ...
        sync_object_full = PipelineAsync._make_sync_object(
            barrier_storage.align(min_align=8),  # type: ignore[attr-defined]
            num_stages,
            producer,
        )
        sync_object_empty = PipelineAsync._make_sync_object(
            barrier_storage.align(min_align=8) + num_stages,  # type: ignore[attr-defined]
            num_stages,
            consumer,
        )
...
class PipelineTmaMultiConsumersAsync(PipelineAsync):
    ...
    def create(  # type: ignore[override]
        *,
        ...
        tx_count: int,
        barrier_storage: cute.Pointer = None,  # type: ignore[assignment]
        cta_layout_vmnk: Optional[cute.Layout] = None,
        defer_sync: bool = False,
    ) -> Any:
        ...
        sync_object_empty_umma = sync_object_empty.recast_to_new_op_type(  # type: ignore[attr-defined]
            consumer_type_umma
        )
        sync_object_empty_async = sync_object_empty.recast_to_new_op_type(  # type: ignore[attr-defined]
            consumer_type_async
        )
    ...
    @dsl_user_op
    def producer_commit(
        self, state: PipelineState, *, loc: Any = None, ip: Any = None
    ) -> Any:
        """
        TMA producer commit is a noop since TMA instruction itself updates the transaction count.
        """
...
class PipelineOrder:
    ...
    **Example:**
    ...
    def get_barrier_for_current_stage_idx(self, group_id: int) -> Int32:
...
class PipelineProducer:
    ...
    **Examples:**
    ...
    @dataclass(frozen=True)
    class ImmutableResourceHandle(ImmutableResourceHandle):  # type: ignore[misc]
        @property
    ...
    def try_acquire(
        ...
        *,
        ...
        :rtype: Boolean
        """
        return self.__pipeline.producer_try_acquire(self.__state, loc=loc, ip=ip)
    ...
    def commit(
        ...
        *,
        ...
        if handle is not None:
            assert handle.get_origin() is self.__pipeline, (
                "ResourceHandle does not belong to this PipelineProducer instance"
            )
            handle.commit(loc=loc, ip=ip)
        else:
    ...
    **Examples:**
    ...
    def wait(
        ...
        *,
        ...
        :rtype: ImmutableResourceHandle
        """
        self.__pipeline.consumer_wait(self.__state, try_wait_token, loc=loc, ip=ip)
    ...
    def wait_and_advance(
        ...
        *,
        ...
        :rtype: ImmutableResourceHandle
        """
        handle = self.wait(try_wait_token, loc=loc, ip=ip)
        self.advance(loc=loc, ip=ip)
        return handle
    ...
    def try_wait(
        ...
        *,
        ...
        :rtype: Boolean
        """
        return self.__pipeline.consumer_try_wait(self.__state, loc=loc, ip=ip)
