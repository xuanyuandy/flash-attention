...
#
# This copy is the editable kernel body for hopper_fwd_minimal. The small
# forward-only launcher lives in hopper_fwd_minimal/interface.py; shared support
# code such as softmax, masks, block info, and schedulers is still imported from
# flash_attn.cute to keep the extraction focused.
