...
class StaticPersistentGroupTileScheduler(StaticPersistentTileScheduler):
    ...
    def _group_search_and_load_problem_shape(
        ...
        *,
        ...
        if found:
            final_group_idx = self.search_state.start_group_idx  # type: ignore[assignment]
        ...
        return found, final_group_idx, problem_mnkl  # type: ignore[return-value]
...
class GroupedGemmTileSchedulerHelper:
    ...
    def _group_search(
        ...
        return GroupedGemmGroupSearchState(
            ...
            tile_count_prev_group,
            tile_count_searched,
            1,  # type: ignore[arg-type]  # found will always be 1 for old api
        )
