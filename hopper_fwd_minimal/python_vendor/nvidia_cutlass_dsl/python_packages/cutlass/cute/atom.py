...
from .typing import Shape, Layout, Tile, Tiler, Tensor, Numeric, Int32, XTuple
from .core import (
    composition,
    coalesce,
    left_inverse,
    ...
    def partition_A(
        ...
        *,
        ...
        return _cute_ir.tiled_mma_partition(
            ...
            self._trait.value,
            input_mk.value,  # type: ignore[attr-defined]
            thr_idx,
            loc=loc,
            ip=ip,
        )
    ...
    def partition_B(
        ...
        *,
        ...
        return _cute_ir.tiled_mma_partition(
            ...
            self._trait.value,
            input_nk.value,  # type: ignore[attr-defined]
            thr_idx,
            loc=loc,
            ip=ip,
        )
    ...
    def partition_C(
        ...
        *,
        ...
        return _cute_ir.tiled_mma_partition(
            ...
            self._trait.value,
            input_mn.value,  # type: ignore[attr-defined]
            thr_idx,
            loc=loc,
            ip=ip,
        )
    ...
    def retile(
        ...
        *,
        ...
        return _cute_ir.tiled_copy_retile(
            ...
            input=src.value,  # type: ignore[attr-defined]
            loc=loc,
            ip=ip,
        )
    ...
    def partition_S(
        ...
        *,
        ...
        return _cute_ir.tiled_copy_partition_S(
            self._trait.value,
            src.value,  # type: ignore[attr-defined]
            thr_idx,
            loc=loc,
            ip=ip,
        )
    ...
    def partition_D(
        ...
        *,
        ...
        return _cute_ir.tiled_copy_partition_D(
            self._trait.value,
            dst.value,  # type: ignore[attr-defined]
            thr_idx,
            loc=loc,
            ip=ip,
        )
...
def copy_atom_call(
    ...
    **Examples**:
    ...
    if isinstance(src_list[0].type, _cute_ir.MemRefType) and isinstance(  # type: ignore[attr-defined]
        ...
        if src_list[0].element_type.width != dst_list[0].element_type.width:  # type: ignore[union-attr]
            raise TypeError(
    ...
    if isinstance(pred, Tensor):
        pred = pred.value  # type: ignore[attr-defined]
